...
class Order {
    ...
    save = ()=>{
         ...
         this.query += "VALUES(" + this.userid + ", '" + this.orderdate + "'," + this.mrptotal + "," + this.priceamount + "," + this.discountamount + "," + this.billamount + " , ";
         this.query += this.shippingamount + "," + this.totalbillamount + ", '" + this.address + " ','" + this.cityname + "','" + this.pincode + "', '" + this.status + "','" + this.paymentstatus + "')";
            ...
            this.db.query(this.query, ( err , result)=>{
                ...
                if(err)
                  ...
                  for(let i = 0; i< this.orderdetails.length;i++)
                  {
                      ...
                      this.query += this.orderdetails[i].quantity + ", " + this.orderdetails[i].mrptotal +", " + this.orderdetails[i].pricetotal +", " + this.orderdetails[i].billamount + ",";
